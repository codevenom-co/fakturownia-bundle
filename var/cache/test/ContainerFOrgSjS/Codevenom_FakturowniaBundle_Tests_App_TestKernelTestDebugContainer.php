...
class Codevenom_FakturowniaBundle_Tests_App_TestKernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Codevenom\\FakturowniaBundle\\Invoice\\Mapper\\CreateInvoicePayloadMapper' => 'getCreateInvoicePayloadMapperService',
     ...
     */
    protected static function getSerializer_NameConverter_CamelCaseToSnakeCaseService($container)
    {
    ...
    {
        return $container->privates['serializer.name_converter.metadata_aware'] = new \Symfony\Component\Serializer\NameConverter\MetadataAwareNameConverter(($container->privates['serializer.mapping.class_metadata_factory'] ?? self::getSerializer_Mapping_ClassMetadataFactoryService($container)), ($container->privates['serializer.name_converter.camel_case_to_snake_case'] ??= new \Symfony\Component\Serializer\NameConverter\CamelCaseToSnakeCaseNameConverter()));
    }
    ...
    private $loadedDynamicParameters = [
        ...
        'codevenom_fakturownia.seller_tax_id' => false,
    ];
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'codevenom_fakturownia.seller_tax_id' => $container->getEnv('default::FAKTUROWNIA_SELLER_TAX_ID'),
